...
const Navigator = (props) => {  
  ...
  return(
    <View style={styles.common.navigationContainer}>
      ...
      <Button color={getColor(2, index)} onPress={Actions.TinderScene} title={strings.tasks} icon='clock-o' />
      <Button color={getColor(3, index)} onPress={Actions.TinderScene} title={strings.lookup} icon='plus' />
      <Button color={getColor(4, index)} onPress={Actions.Profile} title={strings.profile} icon='gears' />
    </View>
  );
}
Navigator.propTypes = {
